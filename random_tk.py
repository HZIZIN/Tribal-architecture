#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Date    : 2019-05-31 15:09:01
# @Author  : H (2066793799@qq.com)
# @Link    : https://io.org
# @Version : $Id$

from tkinter import * # 随机光标样式
...
def rbitmap():
    Bitmap_list = ["error", "gray75", "gray50", "gray25", "gray12",
                   "hourglass", "info", "questhead", "question", "warning"]
    return choice(bitmap_list)


def rrelief():
    '''random button relief'''
    relief_list = ['flat', 'raised', 'sunken', 'groove', 'ridge', 'solid']
    return choice(relief_list)


def rcursor():
    '''Random cursor effect'''
    Cursors_list = ["arrow", "circle", "clock", "cross", "dotbox", "exchange",
                    "fleur", "heart", "heart", "man", "mouse", "pirate", "plus", "shuttle",
                    "sizing", "spider", "spraycan", "star", "target", "tcross", "trek", "watch"]
    return choice(Cursors_list)
