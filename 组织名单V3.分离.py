...
lixainchengyuan = ["00","2019.7.2.18:59","流浪","部落元老"]
tree = ttk.Treeview(root, columns=columns)#, height=18, show="headings", style="mystyle.Treeview")  # 调用外部样式
...
memberList = open('MemberList.txt', mode='rt', encoding='ansi')
dd = 1
xulie = 0
...
# =========================================================================离线成员
memberList = open('afieldList.txt', mode='rt', encoding='ansi')
member = 1
nameRanking = xulie
id2 = tree.insert("", nameRanking, "dir0", text="塔台", values=lixainchengyuan)
while member:
    ...
    nameRanking += 1
    tree.insert(id2, "end", values=offlinename)

tree.pack(fill='both', expand=1)
# ============================================================================右键菜单
menu = tk.Menu(root, tearoff=1, title='组织架构调整', cursor='man')
